...
## 2026-05-26 - Use procedural jellyfish for 3d-form-2 work copy

Decision: replace project cards in `3d-form-2_work_v2` with procedural Three.js jellyfish instead of embedding a third-party GLB model.

Reason: the available external model sources required authentication/account flows for download, while procedural meshes allow immediate local iteration, exact palette matching, animation control, hover hit proxies, and no new licensing or dependency risk.
